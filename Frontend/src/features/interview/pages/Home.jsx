        ...
        <div className='home-page'>
            ...
            <nav className='home-nav'>
                ...
                <button type="button" className='logout-btn' onClick={handleLogout}>
                    <svg height="0.8rem" style={{ marginRight: "0.4rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
